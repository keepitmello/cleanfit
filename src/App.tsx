  ...
  return (
    <div className="min-h-screen font-sans">
      ...
      <div ref={heroRef} className="relative h-screen overflow-hidden bg-background text-foreground selection:bg-white/20">
        ...
        {/* Hero Content */}
        <div className="relative z-10 max-w-7xl mx-auto px-8 flex flex-col justify-center h-[calc(100vh-100px)]">
          <div className="max-w-3xl">
            <motion.span
              className="inline-block px-3 py-1 mb-6 text-xs font-bold tracking-widest uppercase bg-white/10 backdrop-blur-sm text-foreground/80 rounded-full border border-white/10"
            ...
            <motion.h1
              className="text-5xl md:text-7xl lg:text-8xl font-black leading-tight tracking-tighter mb-8 text-foreground drop-shadow-lg"
              initial={{ opacity: 0, y: 40 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.3 }}
            >
              투명한 가격의<br /><span className="text-foreground/70">정직한 청소</span>
            </motion.h1>
            <motion.p
              className="text-lg md:text-2xl text-foreground/80 mb-10 max-w-xl leading-relaxed drop-shadow"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <button className="bg-white/10 backdrop-blur-sm border border-white/20 text-foreground px-10 py-4 rounded-lg font-bold text-lg hover:bg-white/20 transition-all drop-shadow">
                가격표 보기
              </button>
            </motion.div>
          </div>
          ...
          >
            ...
            <motion.div
              className="w-5 h-8 rounded-full border-2 border-foreground/30 flex justify-center pt-1.5"
              animate={{ y: [0, 6, 0] }}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Reveal key={item.title} delay={i * 0.15} direction="up">
                <div className="bg-white p-10 rounded-2xl border border-slate-100 flex flex-col justify-between group hover:border-sky-200 hover:shadow-xl transition-all duration-300 h-full">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Reveal key={item.name} delay={i * 0.15} direction={i === 0 ? "left" : i === 2 ? "right" : "up"}>
        ...
        <div className="max-w-7xl mx-auto text-white">
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-16">
            {[
              ...
              <Reveal key={item.num} delay={i * 0.2} direction="up">
      ...
      <footer className="py-12 bg-slate-100 border-t border-slate-200">
        <div className="flex flex-col md:flex-row justify-between items-center px-6 lg:px-12 max-w-screen-2xl mx-auto gap-4">
          ...
          <div className="text-sm font-medium text-slate-500 opacity-80">
            &copy; 2026 Clean Fit. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
